...
namespace JunglePosition
{
    class Program
    {
        ...
        {
            Config = new Menu("无伤打野位置", "JunglePosition", true);
            Config.AddItem(new MenuItem("Show", "显示无伤打野位置").SetValue(new Circle(true, Color.GreenYellow)));
            Config.AddToMainMenu();

            Drawing.OnDraw += Drawing_OnDraw;
            Game.PrintChat(
                "<font color='#70DBDB'>xQx | </font><font color='#FFFFFF'>鏃犱激鎵撻噹浣嶇疆 -鍔犺浇鎴愬姛!</font> <font color='#70DBDB'> Vee姹夊寲</font>");
        }
