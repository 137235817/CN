...
namespace KaiHelper.Misc
{
    internal class Vision
    {
        ...
        {
            _menu = menu.AddSubMenu(new Menu("敌方视野", "Enemyvision"));
            _menu.AddItem(new MenuItem("VongTron", "只显示圈").SetValue(false));
            _menu.AddItem(new MenuItem("NguoiChoiTest", "显示我方视野").SetValue(false));
