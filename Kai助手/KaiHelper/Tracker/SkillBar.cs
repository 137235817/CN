...
namespace KaiHelper.Tracker
{
    public class SkillBar
    {
        ...
        {
            MenuSkillBar = config.AddSubMenu(new Menu("技能CD监测", "SkillBar"));
            MenuSkillBar.AddItem(new MenuItem("OnAllies", "显示队友CD").SetValue(false));
            MenuSkillBar.AddItem(new MenuItem("OnEnemies", "显示敌方CD").SetValue(true));
