...
namespace EasyJinx
{
    class EasyJinx : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_eslow", "对减慢敌人使用E").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_estun", "对晕眩的敌人使用E").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_egap", "使用E防突进").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_r", "使用R").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_minrange", "R最小范围").SetValue(new Slider(1050, 0, 1500)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_maxrange", "R最大范围").SetValue(new Slider(3000, 1500, 5000)));
