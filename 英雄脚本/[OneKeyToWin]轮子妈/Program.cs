...
namespace Sivir
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.AddItem(new MenuItem("Edmg", "伤害超过%血量使用E").SetValue(new Slider(0, 100, 0)));

            //Add the events we are going to use:
            Game.OnGameUpdate += Game_OnGameUpdate;
            Orbwalking.AfterAttack += AfterAttackEvenH;
            Game.PrintChat("<font color=\"#9c3232\">S</font>ivir full automatic AI ver 1.2 <font color=\"#000000\">by sebastiank1</font> - <font color=\"#00BFFF\">鍔犺浇鎴愬姛  Vee姹夊寲</font>");
