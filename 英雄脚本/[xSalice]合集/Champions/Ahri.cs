    ...
    class Ahri : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var harass = new Menu("骚扰", "Harass");
            {
               ...
               harass.AddItem(new MenuItem("qHit2", "Q/E命中率",true).SetValue(new Slider(3, 1, 4)));
            ...
            var misc = new Menu("其他", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("mana", "使用R之前检测蓝量",true).SetValue(true));
            ...
            var drawing = new Menu("范围显示", "Drawings");
            {
                ...
                drawing.AddItem(
                        new MenuItem("Draw_Mode", "显示E调式",true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
