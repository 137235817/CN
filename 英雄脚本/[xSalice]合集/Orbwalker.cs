...
namespace xSaliceReligionAIO
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(new MenuItem("orb_Draw_hitbox", "显示攻击设置").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Lasthit", "可击杀小兵").SetValue(new Circle(true, Color.Lime)));
            ...
            menuMisc.AddItem(new MenuItem("orb_Misc_Farmdelay", "补刀延迟").SetValue(new Slider(0, 0, 300)));
            if(MyHero.ChampionName == "Azir")
                menuMisc.AddItem(new MenuItem("azir_Misc_Farmdelay", "小兵补刀延迟").SetValue(new Slider(0, 0, 300)));
            menuMisc.AddItem(new MenuItem("orb_Misc_ExtraWindUp", "其他延迟").SetValue(new Slider(80, 200, 0)));
            menuMisc.AddItem(new MenuItem("orb_Misc_AutoWindUp", "自动设置延迟").SetValue(new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Priority_Unit", "优先目标").SetValue(new StringList(new[] { "小兵", "英雄" })));
            menuMisc.AddItem(new MenuItem("orb_Misc_Humanizer", "人性化延迟").SetValue(new Slider(50, 0, 500)));
            ...
            menuMelee.AddItem(new MenuItem("orb_Melee_Prediction", "走位预测").SetValue(false));
            menu.AddSubMenu(menuMelee);

            var menuModes = new Menu("走砍模式", "orb_Modes");
            {
                var modeCombo = new Menu("连招", "orb_Modes_Combo");
                modeCombo.AddItem(new MenuItem("Combo_Key", "连招键").SetValue(new KeyBind(32, KeyBindType.Press)));
                ...
                modeHarass.AddItem(new MenuItem("Harass_Key", "骚扰键").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneClear.AddItem(new MenuItem("LaneClear_Key", "清线键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLaneFreeze.AddItem(new MenuItem("LaneFreeze_Key", "控线键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeLasthit.AddItem(new MenuItem("LastHit_Key", "补刀键").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
                ...
                modeFlee.AddItem(new MenuItem("Flee_Key", "逃跑键").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                menuModes.AddSubMenu(modeFlee);
            }
            menu.AddSubMenu(menuModes);
            menu.AddItem(new MenuItem("xSLx_info2", "Vee汉化"));
