...
namespace Veigar__The_Tiny_Master_Of_Evil
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Menu
            menu = new Menu("邪恶小法师", ChampionName, true);
            ...
            //Orbwalker
            orbwalkerMenu.AddItem(new MenuItem("Orbwalker_Mode", "常规走砍").SetValue(false));
            ...
            menu.SubMenu("Keys");
            menu.SubMenu("Keys").AddItem(new MenuItem("Combo", "智能连招").SetValue(new KeyBind(32, KeyBindType.Press, false)));
            menu.SubMenu("Keys").AddItem(new MenuItem("AllInActive", "使用所有技能").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("LastHitQQ", "Q补刀[自动]").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Keys").AddItem(new MenuItem("LastHitQ", "Q补刀[按键]").SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Press, false)));
            ...
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDdisplay", "头顶显示").SetValue(true));
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDX", "X轴").SetValue(new Slider(67, 0, 100)));
            menu.SubMenu("Drawings").SubMenu("HUD Settings").AddItem(new MenuItem("HUDY", "Y轴").SetValue(new Slider(86, 0, 100)));
            ...
            menu.SubMenu("Drawings").AddItem(new MenuItem("QRange", "Q,R范围").SetValue(new Circle(true, Color.FromArgb(255, 0, 255, 0))));
            ...
            menu.SubMenu("Drawings").AddItem(new MenuItem("MinionMarker", "标记可用Q小兵").SetValue(new Circle(true, Color.Green)));
            menu.SubMenu("Drawings").AddItem(new MenuItem("TText", "显示目标").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("LText", "显示选中目标[血条]").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("ExtraNeeded1", "血条添加E/N指示器").SetValue(true));
            menu.SubMenu("Drawings").AddItem(new MenuItem("OptimalCombo", "显示最佳连招击杀组合[掉FPS]").SetValue(false));

            //Mana Manager menu:
            menu.AddSubMenu(new Menu("法力值控制", "manam"));
            menu.SubMenu("manam").AddItem(new MenuItem("manaStatus", "显示法力值状态").SetValue(true));
            menu.SubMenu("manam").AddItem(new MenuItem("wusage", "法力值大于(%)技能清兵").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("qusage", "法力值大于(%)Q补兵").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("husage", "法力值大于(%)骚扰").SetValue(new Slider(0)));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveEW", "留E的法力值(清线)").SetValue(false));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveE", "留E的法力值(Q补兵)").SetValue(false));
            menu.SubMenu("manam").AddItem(new MenuItem("SaveEH", "留E的法力值(骚扰)").SetValue(false));

            //Misc menu:
            menu.AddSubMenu(new Menu("其他", "Other"));
            menu.SubMenu("Other").AddSubMenu(new Menu("自动W设置", "wsets"));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("Wimm", "对被控制的目标自动W").SetValue(true));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("Wimmz", "对无敌状态将要结束目标使用W").SetValue(true));
            menu.SubMenu("Other").SubMenu("wsets").AddItem(new MenuItem("DontWimm", "连招时禁用自动W").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("StunUnderTower", "眩晕塔下骚扰的敌人").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("UseInt", "使用E打断技能").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("UseGap", "使用E防突进").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("PotOnIGN", "被引燃时使用血瓶").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("buystart", "购买出门装").SetValue(new KeyBind("P".ToCharArray()[0], KeyBindType.Press, false)));
            menu.SubMenu("Other").AddItem(new MenuItem("Reset", "移除目标锁定").SetValue(new KeyBind("L".ToCharArray()[0], KeyBindType.Press, false)));
            menu.SubMenu("Other").AddItem(new MenuItem("packet", "使用封包").SetValue(true));
            menu.SubMenu("Other").AddItem(new MenuItem("Show", "显示图片").SetValue(true));
            ...
            //Notifications
            menu.AddSubMenu(new Menu("通知设置", "notes"));
            menu.SubMenu("notes").AddItem(new MenuItem("noteactive", "使用文字通知").SetValue(true));
            menu.SubMenu("notes").AddItem(new MenuItem("notems", "你的ms < 目标ms时提醒[连招]").SetValue(true));
            menu.SubMenu("notes").AddItem(new MenuItem("notebuffs", "目标身上有BUFF时提醒").SetValue(false));
            menu.SubMenu("notes").AddItem(new MenuItem("notetenacity", "如果E眩晕< W延迟时提醒").SetValue(true));
            ...
            menu.SubMenu("Jungle Clear").AddItem(new MenuItem("UseAAJungle", "使用平A").SetValue(true));
            menu.SubMenu("Jungle Clear").AddItem(new MenuItem("UseQJungle", "使用Q").SetValue(true));
            menu.SubMenu("Jungle Clear").AddItem(new MenuItem("UseWJungle", "使用W").SetValue(true));
            menu.SubMenu("Jungle Clear").AddItem(new MenuItem("UseEJungle", "使用E").SetValue(true));

            //Auto KS
            menu.AddSubMenu(new Menu("自动击杀", "AutoKS"));
            menu.SubMenu("AutoKS").AddItem(new MenuItem("UseQKS", "使用Q").SetValue(true));
            menu.SubMenu("AutoKS").AddItem(new MenuItem("UseWKS", "使用W").SetValue(false));
            menu.SubMenu("AutoKS").AddItem(new MenuItem("UseRKS", "使用R").SetValue(false));
            menu.SubMenu("AutoKS").AddItem(new MenuItem("UseIGNKS", "使用引燃").SetValue(false));
            menu.SubMenu("AutoKS").AddItem(new MenuItem("DisableKS", "连招时禁用自动击杀").SetValue(false));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("HarassMode", "选择骚扰类型").SetValue(new StringList(new[] { "E+W+Q", "E+W", "Q", "都不用" }, 0)));
            menu.SubMenu("Harass").AddItem(new MenuItem("WaitW", "Q前先释放W").SetValue(false));

            //Combo menu:
            menu.AddSubMenu(new Menu("连招释放", "Combo"));
            menu.SubMenu("Combo").AddItem(new MenuItem("LockTargets", "左击锁定目标").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("DontEShields", "对有技能保护敌人不使用E").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("ToOrb", "[内置]连招时走砍").SetValue(false));
            menu.SubMenu("Combo").AddItem(new MenuItem("CastMode", "E/W设置").SetValue(new StringList(new[] { "先E后W", "先W后E", }, 0)));
            menu.SubMenu("Combo").AddSubMenu(new Menu("智能连招设置", "MainCombo"));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("ComboWaitMode", "选中模式:").SetValue(new StringList(new[] { "等待W落地", "不等待W落地", }, 0)));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreQ", "Q释放不等待W命中检测").SetValue(false));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreR", "R释放不等待W命中检测").SetValue(false));
            menu.SubMenu("Combo").SubMenu("MainCombo").SubMenu("If combo requires successful W hit").AddItem(new MenuItem("IgnoreIGN", "引燃释放不等待W命中检测").SetValue(false));
            ...
            Game.PrintChat("Veigar, The Tiny Master Of Evil 鍔犺浇鎴愬姛  Vee姹夊寲");
        }
