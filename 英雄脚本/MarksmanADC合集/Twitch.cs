...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "使用E|最大层数").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "使用E丨最大层数").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseEM" + Id, "使用E击杀").SetValue(true));
            return true;
        }
