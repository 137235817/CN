...
namespace Marksman
{
    internal class Corki : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "保留R层数").SetValue(new Slider(0, 0, 7)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimH" + Id, "保留R层数").SetValue(new Slider(3, 0, 7)));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseRM" + Id, "使用大招抢人头").SetValue(true));
            return true;
        }
