...
namespace Marksman
{
    internal class Varus : Champion
    {
        ...
        {
            config.AddItem(new MenuItem("UseQC" + Id, "Q").SetValue(new StringList(new[] {"关闭", "任何时刻", "W堆叠时", "最大W层数"}, 3)));
            config.AddItem(new MenuItem("UseQMinChargeC" + Id, "最小Q控制").SetValue(new Slider(1000, 250, 1400)));
        ...
        {
            config.AddItem(new MenuItem("spellDelay" + Id, "技能延迟").SetValue(new Slider(500, 0, 3000)));
            config.AddItem(
        ...
        {
            config.AddItem(new MenuItem("DrawQ" + Id, "Q范围").SetValue(new Circle(true, Color.DarkGray)));
            config.AddItem(new MenuItem("DrawE" + Id, "E范围").SetValue(new Circle(true, Color.DarkGray)));
            config.AddItem(new MenuItem("DrawR" + Id, "R范围").SetValue(new Circle(true, Color.DarkGray)));
            config.AddItem(new MenuItem("DrawQC" + Id, "最小Q控制").SetValue(new Circle(true, Color.White)));
            config.AddItem(new MenuItem("DrawRS" + Id, "R范围").SetValue(new Circle(true, Color.White)));
