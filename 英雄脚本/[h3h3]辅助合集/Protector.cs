    ...
    internal class Protector
    {
        ...
        public static void Init()
        {
            if (!_isInitComplete)
            {
                ...
                Helpers.PrintMessage(string.Format("Protector by h3h3 鍔犺浇鎴愬姛 Vee姹夊寲!"));
        ...
        {
            Menu = new Menu("辅助: 保护", "Protector", true);

            // detector
            var detector = Menu.AddSubMenu(new Menu("探测器", "Detector"));

            // detector targeted
            var targeted = detector.AddSubMenu(new Menu("目标", "Targeted"));
            ...
            // detector skillshots
            var skillshot = detector.AddSubMenu(new Menu("技能", "Skillshots"));
            ...
            // cc
            var cc = Menu.AddSubMenu(new Menu("控制技能", "CC"));
            ...
            // misc
            var misc = Menu.AddSubMenu(new Menu("其他", "Misc"));
