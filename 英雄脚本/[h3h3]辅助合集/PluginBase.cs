...
namespace Support
{
    ...
    public abstract class PluginBase
    {
        ...
        protected PluginBase()
        {
            ...
            Helpers.PrintMessage(string.Format("{0} by {1} v.{2} 鍔犺浇鎴愬姛 Vee姹夊寲!", ChampionName, Author, Version));
        }
        ...
        {
            Config = new Menu("辅助: " + Player.ChampionName, Player.ChampionName, true);
            ...
            ManaConfig = Config.AddSubMenu(new Menu("法力值控制", "Mana Limiter"));
            MiscConfig = Config.AddSubMenu(new Menu("其他", "Misc"));
            InterruptConfig = Config.AddSubMenu(new Menu("打断", "Interrupt"));
            DrawingConfig = Config.AddSubMenu(new Menu("显示", "Drawings"));

            // mana
            ManaConfig.AddSlider("HarassMana", "控蓝 %", 1, 1, 100);
            ...
            DrawingConfig.AddItem(
                new MenuItem("QRange" + ChampionName, "Q范围").SetValue(
                    new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            DrawingConfig.AddItem(
                new MenuItem("WRange" + ChampionName, "W范围").SetValue(
                    new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            DrawingConfig.AddItem(
                new MenuItem("ERange" + ChampionName, "E范围").SetValue(
                    new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            DrawingConfig.AddItem(
                new MenuItem("RRange" + ChampionName, "R范围").SetValue(
                    new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
