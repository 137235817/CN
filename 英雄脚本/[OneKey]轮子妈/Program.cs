...
namespace Sivir
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("[OneKey]轮子妈", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("farmW", "W补兵").SetValue(true));
            Config.AddItem(new MenuItem("Hit", "Q命中率").SetValue(new Slider(2, 2, 0)));
            Config.AddItem(new MenuItem("autoR", "自动R").SetValue(true));
            #region Shield
                Config.SubMenu("E Shield Config").AddItem(new MenuItem("autoE", "自动E").SetValue(true));
                Config.SubMenu("E Shield Config").AddItem(new MenuItem("AGC", "自动E防突进").SetValue(true));
                Config.SubMenu("E Shield Config").AddItem(new MenuItem("Edmg", "伤害高于生命值%使用E").SetValue(new Slider(0, 100, 0))); 
            #endregion
            ...
            Game.PrintChat("<font color=\"#9c3232\">S</font>ivir full automatic AI ver 1.5 <font color=\"#000000\">by sebastiank1</font> - <font color=\"#00BFFF\">鍔犺浇鎴愬姛  Vee姹夊寲</font>");
