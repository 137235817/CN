...
namespace D_Corki
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config.SubMenu("Combo").AddSubMenu(new Menu("W设置", "Use W"));
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("UseWC", "使用W")).SetValue(true);
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("diveintower", "W冲进塔下")).SetValue(true);
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("UseWHE", "使用W|你的血量").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Combo").SubMenu("Use W").AddItem(new MenuItem("EnemyC", "使用W|R范围内敌人少于").SetValue(new Slider(2, 1, 5)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("RlimH", "使用R丨最小人数").SetValue(new Slider(3, 1, 7)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "骚扰(自动)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "蓝量控制").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("UseQL", "Q清线")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseEL", "E清线")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseRL", "R清线")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseQLH", "Q补刀")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseELH", "E补刀")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseQJ", "Q清野")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseEJ", "E清野")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseRJ", "R清野")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("RlimL", "使用R最小层数").SetValue(new Slider(3, 1, 7)));
            _config.SubMenu("Farm").AddItem(new MenuItem("Lanemana", "蓝量控制").SetValue(new Slider(60, 1, 100)));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEM", "使用E抢人头")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseRM", "使用R抢人头")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("skinC", "使用换肤").SetValue(false));
            ...
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("QchangeHar", "Q命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("EchangeHar", "E命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("RchangeHar", "R命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("连招", "Combo"));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Qchange", "Q命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Echange", "E命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Rchange", "R命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("抢人头", "KillSteal"));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Qchangekil", "Q命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Echangekil", "E命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Rchangekil", "R命中率").SetValue(
                new StringList(new[] { "低", "正常", "高", "非常高" })));
            ...
            Game.PrintChat("<font color='#881df2'>D-椋炴満鍔犺浇鎴愬姛 Vee姹夊寲.");
            Game.PrintChat(
