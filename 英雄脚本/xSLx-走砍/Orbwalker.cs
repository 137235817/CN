...
namespace xSLx_Orbwalker
{
	...
	public class xSLxOrbwalker
	{
		...
		public static void AddToMenu(Menu menu)
		{
			...
			menuMisc.AddItem(new MenuItem("orb_Misc_Holdzone", "待命区域").SetValue(new Slider(50, 100, 0)));
			...
			menuMisc.AddItem(new MenuItem("orb_Misc_AutoWindUp", "自动延迟").SetValue(false));
			menuMisc.AddItem(new MenuItem("orb_Misc_Priority_Unit", "优先目标").SetValue(new StringList(new[] { "小兵", "英雄" })));
			menuMisc.AddItem(new MenuItem("orb_Misc_Humanizer", "人性化延迟").SetValue(new Slider(80, 200, 15)));
