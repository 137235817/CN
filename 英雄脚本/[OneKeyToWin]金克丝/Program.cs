...
namespace Jinx
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            SpellList.Add(R1);
            //Create the menu
            Config = new Menu("[OneKeyToWin]金克丝", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("opsE", "使用E").SetValue(true));
            Config.AddItem(new MenuItem("hitchanceR", "高命中率大招").SetValue(true));
            Config.AddItem(new MenuItem("autoR", "自动使用大招").SetValue(true));
            Config.AddItem(new MenuItem("useR", "半自动释放大招").SetValue(new KeyBind('t', KeyBindType.Press))); //32 == space
            ...
            Game.PrintChat("<font color=\"#ff00d8\">J</font>inx full automatic SI ver 1.9 <font color=\"#000000\">by sebastiank1</font> - <font color=\"#00BFFF\">鍔犺浇鎴愬姛  Vee姹夊寲</font>");
        }
