...
namespace Marksman
{
    internal class PotionManager
    {
        ...
        private void Load()
        {
            ...
            ExtrasMenu.AddSubMenu(new Menu("吃药管理", "PotionManager"));
            ...
            ExtrasMenu.SubMenu("PotionManager")
                .SubMenu("Health")
                .AddItem(new MenuItem("HealthPercent", "红药|触发生命值百分比").SetValue(new Slider(30)));

            ExtrasMenu.SubMenu("PotionManager").AddSubMenu(new Menu("法力", "Mana"));
            ExtrasMenu.SubMenu("PotionManager")
                .SubMenu("Mana")
                .AddItem(new MenuItem("ManaPotion", "使用蓝药").SetValue(true));
            ExtrasMenu.SubMenu("PotionManager")
                .SubMenu("Mana")
                .AddItem(new MenuItem("ManaPercent", "蓝药|触发法力值百分比").SetValue(new Slider(30)));
