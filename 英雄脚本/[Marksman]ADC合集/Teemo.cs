...
namespace Marksman
{
    internal class Teemo : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRC" + Id, "使用R").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseQM" + Id, "使用Q抢人头").SetValue(true));
            return true;
        }

        public override bool ExtrasMenu(Menu config)
        {
            config.AddItem(new MenuItem("AutoRI" + Id, "自动使用R").SetValue(true));
            return true;
        }
