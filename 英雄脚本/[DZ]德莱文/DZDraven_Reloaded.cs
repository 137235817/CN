...
namespace DZDraven_Reloaded
{
    internal class DZDraven_Reloaded
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu.SubMenu("Axes")
                .AddItem(new MenuItem("MaxAxeH", "骚扰最大接斧头数").SetValue(new Slider(2, 1, 4)));
            ...
            Menu.SubMenu("Axes").AddItem(new MenuItem("SafeZone", "接斧头安全区域").SetValue(new Slider(125, 0, 325)));
            Menu.AddSubMenu(new Menu("其他", "Misc"));
            Menu.SubMenu("Misc")
                .AddItem(
                    new MenuItem("ManualR", "手动大招").SetValue(
            ...
            Menu.SubMenu("Items")
                .AddItem(new MenuItem("OwnHPercBotrk", "自身血量低于%使用破败").SetValue(new Slider(50, 1)));
            Menu.SubMenu("Items")
            ...
            Menu.AddSubMenu(new Menu("水银解除技能效果", "QSSSpell"));
