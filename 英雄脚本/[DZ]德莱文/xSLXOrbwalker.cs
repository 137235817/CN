...
namespace DZDraven_Reloaded
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuMisc.AddItem(
                new MenuItem("orb_Misc_AutoWindUp", "自动设置").SetValue(
                    new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            menuMisc.AddItem(
                new MenuItem("orb_Misc_Priority_Unit", "优先模式").SetValue(
            ...
            var menuModes = new Menu("走砍模式", "orb_Modes");
            {
                ...
                modeCombo.AddItem(new MenuItem("Combo_Key", "连招").SetValue(new KeyBind(32, KeyBindType.Press)));
