...
public class Xerath : Champion
{
    ...
    protected override void OnInitMenu()
    {
        ...
        BoolLinks.Add("combo_q", comboMenu.AddLinkedBool("使用Q", true));
        BoolLinks.Add("combo_w", comboMenu.AddLinkedBool("使用W", true));
        BoolLinks.Add("combo_e", comboMenu.AddLinkedBool("使用E", true));

        MenuWrapper.SubMenu harassMenu = Menu.MainMenu.AddSubMenu("骚扰");
        BoolLinks.Add("harass_q", harassMenu.AddLinkedBool("使用Q", true));
        BoolLinks.Add("harass_w", harassMenu.AddLinkedBool("使用W", false));
        BoolLinks.Add("harass_e", harassMenu.AddLinkedBool("使用E", false));
        SliderLinks.Add("harass_mana", harassMenu.AddLinkedSlider("法力值控制", 200, 0, 500));

        MenuWrapper.SubMenu autoMenu = Menu.MainMenu.AddSubMenu("自动");
        BoolLinks.Add("auto_q", autoMenu.AddLinkedBool("使用Q", false));
        BoolLinks.Add("auto_w", autoMenu.AddLinkedBool("使用W", false));
        BoolLinks.Add("auto_e", autoMenu.AddLinkedBool("使用E", false));
        BoolLinks.Add("auto_e_interrupt", autoMenu.AddLinkedBool("使用E打断", true));
        BoolLinks.Add("auto_e_slows", autoMenu.AddLinkedBool("对减速敌人使用E", false));
        BoolLinks.Add("auto_e_stuns", autoMenu.AddLinkedBool("对眩晕敌人使用E", true));
        BoolLinks.Add("auto_e_gapclosers", autoMenu.AddLinkedBool("使用E防突进", true));
        SliderLinks.Add("auto_mana", autoMenu.AddLinkedSlider("法力值控制", 200, 0, 500));

        MenuWrapper.SubMenu drawingMenu = Menu.MainMenu.AddSubMenu("显示");
        BoolLinks.Add("drawing_q", drawingMenu.AddLinkedBool("显示Q范围", true));
        BoolLinks.Add("drawing_w", drawingMenu.AddLinkedBool("显示W范围", true));
        BoolLinks.Add("drawing_e", drawingMenu.AddLinkedBool("显示E范围", true));
        BoolLinks.Add("drawing_r", drawingMenu.AddLinkedBool("显示R范围", true));
        BoolLinks.Add("drawing_r_map", drawingMenu.AddLinkedBool("小地图显示R范围", true));
        BoolLinks.Add("drawing_damage", drawingMenu.AddLinkedBool("显示R伤害指示器", true));

        MenuWrapper.SubMenu miscMenu = Menu.MainMenu.AddSubMenu("其他");
        KeyLinks.Add("misc_e", miscMenu.AddLinkedKeyBind("E手动键", 'T', KeyBindType.Press));
        BoolLinks.Add("misc_w", miscMenu.AddLinkedBool("对集中人群使用W", true));
        BoolLinks.Add("misc_r", miscMenu.AddLinkedBool("大招自动控制", true));
        SliderLinks.Add("misc_r_min_delay", miscMenu.AddLinkedSlider("R最小延迟", 800, 0, 1500));
        SliderLinks.Add("misc_r_max_delay", miscMenu.AddLinkedSlider("R最大延迟", 1750, 1500, 3000));
        SliderLinks.Add("misc_r_dash", miscMenu.AddLinkedSlider("对闪现/突进敌人R延迟", 500, 0, 2000));
        BoolLinks.Add("misc_r_blue", miscMenu.AddLinkedBool("大招时使用蓝色饰品", true));
