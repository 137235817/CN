...
namespace Annie
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("[OneKey]安妮", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("useR", "半自动R按键").SetValue(new KeyBind('t', KeyBindType.Press)));//32 == space
            //Add the events we are going to use:
            Game.OnGameUpdate += Game_OnGameUpdate;
            Orbwalking.BeforeAttack += Orbwalking_BeforeAttack;
            Game.PrintChat("<font color=\"#ff00d8\">J</font>inx full automatic SI ver 1.5 -Loaded<font color=\"#000000\">by sebastiank1</font> - <font color=\"#00BFFF\">涓鍔犺浇鎴愬姛  Vee姹夊寲</font>");
        }
