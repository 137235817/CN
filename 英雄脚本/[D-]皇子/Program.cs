...
namespace D_Jarvan
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseIgnite", "使用引燃")).SetValue(true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRC", "使用R(可击杀)")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRE", "团战连招自动使用R")).SetValue(true);
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("MinTargets", "敌人数量>使用大招").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Combo")
            ...
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Tiamat", "使用提亚玛特")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hydra", "使用九头蛇")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilge", "使用比尔吉沃特弯刀")).SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("BilgeEnemyhp", "敌人血量低于%").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Bilgemyhp", "自己血量低于%").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Blademyhp", "自己血量低于%").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").AddSubMenu(new Menu("防御物品", "Deffensive"));
            _config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Omen", "使用兰盾"))
                .SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Deffensive")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionhp", "血量低于%使用").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Potions")
            ...
            _config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usepotionmp", "法力值低于%使用").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("UseEQH", "使用EQ 连招")).SetValue(true);
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("UseEQHHP", "自己血量>使用EQ").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("Harass").AddItem(new MenuItem("UseItemsharass", "使用提亚玛特/九头蛇")).SetValue(true);
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("harassmana", "法力值控制").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            //LaneClear
            _config.AddSubMenu(new Menu("补兵", "Farm"));
            _config.SubMenu("Farm").AddSubMenu(new Menu("清线", "LaneFarm"));
            _config.SubMenu("Farm")
                .SubMenu("LaneFarm")
                .AddItem(new MenuItem("UseItemslane", "清线使用物品"))
                .SetValue(true);
            ...
            _config.SubMenu("Farm").SubMenu("LaneFarm").AddItem(new MenuItem("UseWL", "W清线")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("LaneFarm")
                .AddItem(new MenuItem("UseWLHP", "血量低于%使用W").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LaneFarm")
                .AddItem(new MenuItem("lanemana", "法力值控制").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LaneFarm")
                .AddItem(
            ...
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseQLH", "Q补刀")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseELH", "E补刀")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseWLH", "W清线")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(new MenuItem("UseWLHHP", "血量低于%使用W").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(new MenuItem("lastmana", "法力值控制").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(
            ...
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(new MenuItem("UseItemsjungle", "清野使用物品"))
                .SetValue(true);
            ...
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem(" UseEQJ", "EQ清野")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(new MenuItem("UseWJHP", "血量低于%使用W").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(new MenuItem("junglemana", "法力值控制").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
                .AddItem(
            ...
            _config.SubMenu("Smite")
                .AddItem(
                    new MenuItem("Usesmite", "使用惩戒(自动)").SetValue(new KeyBind("H".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Smite").AddItem(new MenuItem("Useblue", "提前惩戒蓝buff")).SetValue(true);
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("manaJ", "法力值低于%提前惩戒蓝buff").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Smite").AddItem(new MenuItem("Usered", "提前惩戒红buff")).SetValue(true);
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "生命值低于%提前惩戒红buff").SetValue(new Slider(35, 1, 100)));

            //Forest
            _config.AddSubMenu(new Menu("逃跑", "Forest Gump"));
            _config.SubMenu("Forest Gump").AddItem(new MenuItem("UseEQF", "向鼠标方向EQ")).SetValue(true);
            _config.SubMenu("Forest Gump").AddItem(new MenuItem("UseWF", "使用W ")).SetValue(true);
            ...
            //Misc
            _config.AddSubMenu(new Menu("其他", "Misc"));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_W", "W 防突击")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEQInt", "EQ打断技能")).SetValue(true);
            ...
            //Drawings
            _config.AddSubMenu(new Menu("范围显示", "Drawings"));
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawQR", "显示EQ-R范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("DrawEQF", "显 EQ-闪现范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("Drawsmite", "显示惩戒范围")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "线圈优化").SetValue(true));
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("CircleQuality", "线圈质量").SetValue(new Slider(100, 100, 10)));
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("CircleThickness", "线圈宽度").SetValue(new Slider(1, 10, 1)));

            _config.AddToMainMenu();
            Game.PrintChat("<font color='#881df2'>D-鐨囧瓙鍔犺浇鎴愬姛 Vee姹夊寲</font>");
